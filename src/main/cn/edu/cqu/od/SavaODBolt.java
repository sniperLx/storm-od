 ...
 * @author lx
 */
//save single car's OD into database
public class SavaODBolt extends BaseRichBolt {
    private static final long serialVersionUID = 1672298012843886345L;
    ...
    private void saveToDB(Tuple tuple) {
        ...
        HashMap<PathInfoNode, PathInfoNode>
                od = (HashMap<PathInfoNode, PathInfoNode>) tuple.getValueByField("single-car-od-map");
